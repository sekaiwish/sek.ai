...
<head>
	...
	<link type="image/png" href="/webassets/favicon/180.png" sizes="180x180" rel="apple-touch-icon">
	<link type="application/json" href="/webassets/manifest.json" rel="manifest">
	<link type="text/css" href="/css/bootstrap.min.css" rel="stylesheet">
	<link type="text/css" href="/css/font-awesome.min.css" rel="stylesheet">
	<link type="text/css" href="/css/style.css" rel="stylesheet">
	<style media="all">
		body{background-image:url(/webassets/gradients/light.png);animation:gradient 5s linear 0s infinite normal;}nav>div>form>.btn{margin-left:8px;}.card-group{justify-content:center;}.card-outline-success{border-width:3px;}.card-outline-danger{border-width:3px;}.card-title{text-shadow:1.25px 1.25px 0 #000,-1.25px -1.25px 0 #000,1.25px -1.25px 0 #000,-1.25px 1.25px 0 #000;}
	</style>
