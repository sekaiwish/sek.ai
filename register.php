...
<p style="text-align:center;color:gray">You will be notified if your application was successful via email.<br><a href="/">Click here</a> to return to the homepage.</p>
</body>
</html>');
}
?>
